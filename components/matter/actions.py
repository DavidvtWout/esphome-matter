...
from .data_model.commands import COMMAND_ARG_TYPES, COMMANDS, Command, is_absolute
from .types import (
    MatterComponent,
    MatterEndpointRef,
...
async def matter_send_command_to_code(
    ...
    provide an esp-matter compatible string yourself.
      ...
      matter._send_command:
        ...
        absolute: true  # optional, see ABSOLUTE_COMMANDS in data_model/commands.py
...
async def _new_send_command_action(
    ...
    cg.add(var.set_absolute(is_absolute(command)))
    return var
